# Generated by Django 2.1.5 on 2019-03-19 16:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('social_auth_login_type', models.CharField(blank=True, choices=[('G', 'Google'), ('F', 'Facebook')], default='', max_length=4)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('fest_liked', models.ManyToManyField(blank=True, related_name='fest_liked', to='fest.Fest')),
